...
// code borrowed from: https://github.com/SerenityOS/serenity/blob/master/Userland/Services/DHCPClient/DHCPv4.h
...
public:
    ...
    ParsedDhcpOptions parse_options() const;
...
public:
    ...
    DhcpPacket& peek() { return m_packet; }
    DhcpPacket& build()
    {
