...
public:
    ...
    static Optional<MACAddress> empty()
    {
        return MACAddress::from_string("00:00:00:00:00:00"sv);
    }

    static Optional<MACAddress> from_parts(unsigned char parts[6])
    {
        return MACAddress(parts[0],parts[1], parts[2], parts[3], parts[4], parts[5]);
    }
